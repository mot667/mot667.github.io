    ...
    <ThemeProvider theme={theme}>
      ...
      >
        ...
        <div class = "row">
          ...
          <div class = "col-md-4">
            <h3 style= {{textAlign: "left", color: "#851E3E", marginLeft: 38}}>
              Details
            </h3>
            <p style = {{textAlign: "left", marginLeft:38}}> 
              <strong>Name: </strong>
              <br></br>
              Tom Keech
              <br></br>
        ...
        <div class = "container" style = {{paddingBottom: "40px", paddingTop: "40px", paddingLeft: "180px", paddingRight: "180px"}}>
            ...
            <div class = "row">
              <div class = "col-md-6"> 
                <ul class = "no-bullets">
                  <li style = {{paddingLeft:20, marginRight:15}}>
                  ...
                  <li style = {{paddingTop:20, paddingLeft:20, marginRight:15}}>
              ...
              <div class = "col-md-6">
              <ul class = "no-bullets">
                  <li style = {{paddingLeft:20, marginLeft:15}}>
                  ...
                  <li style = {{paddingTop:20,paddingLeft:20, marginLeft:15}}>
